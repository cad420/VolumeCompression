    ...
    m_hEncoder(nullptr)
{
    ...
    encodeSessionExParams.deviceType = m_eDeviceType;//CUDA OpenGL DirectX
...
void NvEncoder::MapResources(uint32_t bfrIdx)//allocate external input device buffer
{
...
//        std::cout<<"lockBitstreamData.outputBitstream: "<<lockBitstreamData.outputBitstream<<std::endl;
        lockBitstreamData.doNotWait = false;
//        std::cout<<"lockBitstreamData.bitstreamBufferPtr before: "<<lockBitstreamData.bitstreamBufferPtr<<std::endl;
        NVENC_API_CALL(m_nvenc.nvEncLockBitstream(m_hEncoder, &lockBitstreamData));

        //lock page ptr
        uint8_t *pData = (uint8_t *)lockBitstreamData.bitstreamBufferPtr;
//        std::cout<<"lockBitstreamData.bitstreamBufferPtr: "<<lockBitstreamData.bitstreamBufferPtr<<std::endl;
        if (vPacket.size() < i + 1)
        {
